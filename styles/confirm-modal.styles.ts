...
export const styles = StyleSheet.create({
	...
	modalContent: { backgroundColor: COLORS.background, padding: 20, borderRadius: 20, borderColor: COLORS.grey, borderWidth: 2 },
	...
	confirmButtonText: { color: COLORS.primary, fontWeight: "bold", fontSize: 16 },
