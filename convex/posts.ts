...
export const createPost = mutation({
	...
	handler: async (ctx, args) => {
		...
		//increment the number of post by 1
...
export const getFeedPosts = query({
	handler: async (ctx) => {
		...
		//enhace posts with userdata and interatcion status
...
export const toggleLike = mutation({
	...
	handler: async (ctx, args) => {
		...
		if (existing) {
			...
			//if its not mine create notififcationn
...
export const deletePost = mutation({
	...
	handler: async (ctx, args) => {
		...
		if (post.userId !== currentUser._id) throw new Error("You can only delete your own post")
		...
		//delete all bookmarks of the post
		...
		//delete all notifications of the post
		...
		//decrement the number of post by 1
		await ctx.db.patch(currentUser._id, {
